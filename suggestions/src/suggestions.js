...
Suggestions.prototype.getCandidates = function(callback) {
  ...
  var results = this.options.filter ?
    ...
    this.data.map(function(d) {
      return {
        original: d,
        admin:'<span class="admin">' + d.properties.county + d.properties.locality+ '</span>',
...
/**
 * /Users/tcsd/Dev/mapbox-gl-directions 2/node_modules/suggestions/src/suggestions.js
